...
namespace CareOnSpot.Migrations
{
    ...
    [Migration("20240509071631_DoctorAppoinmentTable")]
    partial class DoctorAppoinmentTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CareOnSpot.Models.Specialitie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 9, 13, 16, 30, 920, DateTimeKind.Unspecified).AddTicks(5378), new TimeSpan(0, 6, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 9, 13, 16, 30, 920, DateTimeKind.Unspecified).AddTicks(5419), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Ophthalmology"
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 9, 13, 16, 30, 920, DateTimeKind.Unspecified).AddTicks(5421), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Pediatrics"
                        },
                        new
                        {
                            Id = 4,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 9, 13, 16, 30, 920, DateTimeKind.Unspecified).AddTicks(5423), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Cardiology"
                        },
                        new
                        {
                            Id = 5,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 9, 13, 16, 30, 920, DateTimeKind.Unspecified).AddTicks(5424), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Psychiatry"
                        },
                        new
                        {
                            Id = 6,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 9, 13, 16, 30, 920, DateTimeKind.Unspecified).AddTicks(5426), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Orthopedics"
                        });
                });
