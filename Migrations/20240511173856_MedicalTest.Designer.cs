...
namespace CareOnSpot.Migrations
{
    ...
    [Migration("20240511173856_MedicalTest")]
    partial class MedicalTest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CareOnSpot.Models.Specialitie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 11, 23, 38, 54, 834, DateTimeKind.Unspecified).AddTicks(9911), new TimeSpan(0, 6, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 11, 23, 38, 54, 834, DateTimeKind.Unspecified).AddTicks(9946), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Ophthalmology"
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 11, 23, 38, 54, 834, DateTimeKind.Unspecified).AddTicks(9948), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Pediatrics"
                        },
                        new
                        {
                            Id = 4,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 11, 23, 38, 54, 834, DateTimeKind.Unspecified).AddTicks(9949), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Cardiology"
                        },
                        new
                        {
                            Id = 5,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 11, 23, 38, 54, 834, DateTimeKind.Unspecified).AddTicks(9951), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Psychiatry"
                        },
                        new
                        {
                            Id = 6,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 11, 23, 38, 54, 834, DateTimeKind.Unspecified).AddTicks(9953), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Orthopedics"
                        });
                });
