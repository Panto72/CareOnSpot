...
namespace CareOnSpot.Migrations
{
    ...
    [Migration("20240513054623_UpdateAmbulanceTable")]
    partial class UpdateAmbulanceTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CareOnSpot.Models.Specialitie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 13, 11, 46, 20, 936, DateTimeKind.Unspecified).AddTicks(8644), new TimeSpan(0, 6, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 13, 11, 46, 20, 936, DateTimeKind.Unspecified).AddTicks(8686), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Ophthalmology"
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 13, 11, 46, 20, 936, DateTimeKind.Unspecified).AddTicks(8690), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Pediatrics"
                        },
                        new
                        {
                            Id = 4,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 13, 11, 46, 20, 936, DateTimeKind.Unspecified).AddTicks(8732), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Cardiology"
                        },
                        new
                        {
                            Id = 5,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 13, 11, 46, 20, 936, DateTimeKind.Unspecified).AddTicks(8735), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Psychiatry"
                        },
                        new
                        {
                            Id = 6,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 13, 11, 46, 20, 936, DateTimeKind.Unspecified).AddTicks(8737), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Orthopedics"
                        });
                });
