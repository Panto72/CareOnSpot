...
namespace CareOnSpot.Migrations
{
    ...
    [Migration("20240514064919_emergencyhelp")]
    partial class emergencyhelp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CareOnSpot.Models.Specialitie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 14, 12, 49, 16, 687, DateTimeKind.Unspecified).AddTicks(4519), new TimeSpan(0, 6, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 14, 12, 49, 16, 687, DateTimeKind.Unspecified).AddTicks(4563), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Ophthalmology"
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 14, 12, 49, 16, 687, DateTimeKind.Unspecified).AddTicks(4566), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Pediatrics"
                        },
                        new
                        {
                            Id = 4,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 14, 12, 49, 16, 687, DateTimeKind.Unspecified).AddTicks(4569), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Cardiology"
                        },
                        new
                        {
                            Id = 5,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 14, 12, 49, 16, 687, DateTimeKind.Unspecified).AddTicks(4571), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Psychiatry"
                        },
                        new
                        {
                            Id = 6,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 14, 12, 49, 16, 687, DateTimeKind.Unspecified).AddTicks(4574), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Orthopedics"
                        });
                });
