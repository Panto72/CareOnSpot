...
namespace CareOnSpot.Migrations
{
    ...
    [Migration("20240514065349_EmergencyhelpUpdate")]
    partial class EmergencyhelpUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CareOnSpot.Models.Specialitie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 14, 12, 53, 48, 434, DateTimeKind.Unspecified).AddTicks(8379), new TimeSpan(0, 6, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 14, 12, 53, 48, 434, DateTimeKind.Unspecified).AddTicks(8419), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Ophthalmology"
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 14, 12, 53, 48, 434, DateTimeKind.Unspecified).AddTicks(8421), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Pediatrics"
                        },
                        new
                        {
                            Id = 4,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 14, 12, 53, 48, 434, DateTimeKind.Unspecified).AddTicks(8423), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Cardiology"
                        },
                        new
                        {
                            Id = 5,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 14, 12, 53, 48, 434, DateTimeKind.Unspecified).AddTicks(8425), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Psychiatry"
                        },
                        new
                        {
                            Id = 6,
                            CreatedBy = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 5, 14, 12, 53, 48, 434, DateTimeKind.Unspecified).AddTicks(8427), new TimeSpan(0, 6, 0, 0, 0)),
                            Description = "Consult dermatologists for skin, hair, and nail conditions.",
                            Title = "Orthopedics"
                        });
                });
